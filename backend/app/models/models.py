...
class Profile(Base):
    ...
    college = Column(String, default="Stanford University")
    major = Column(String, default="Computer Science")
    cohort_standing = Column(String, default="Top 15%")
    current_gpa = Column(Float, default=3.88)
    target_gpa = Column(Float, default=4.00)
