...
export const HomeScreen: React.FC<HomeScreenProps> = ({
  ...
  return (
    <div className="flex flex-col w-full px-4 space-y-4 max-w-max-content-width mx-auto pb-4 pt-1">
      ...
      <div className="flex items-center justify-between pt-1">
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            <h1 className="text-2xl font-semibold text-[#1a1a1a] truncate tracking-tight">
              Good morning, Alex
            </h1>
      ...
      {/* Nearby Services & Campus Essentials Carousel */}
      <div className="space-y-3 pt-2">
        ...
        <div className="flex gap-3 overflow-x-auto pb-2 pt-0.5 no-scrollbar -mx-4 px-4">
          {spots.slice(0, 4).map((spot) => (
            <div
              key={spot.id}
              onClick={() => onNavigateTab('explore')}
              className="shrink-0 w-44 bg-white rounded-2xl p-3 shadow-xs space-y-2 cursor-pointer hover:border-gray-300 transition-all active:scale-[0.98] border border-gray-200"
            >
